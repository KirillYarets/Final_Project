...
def spark_code_base():
    ...
    df_base = spark.read.csv(
        f"webhdfs://192.168.0.110:50070/Data_lake/Bronse/db_data/folder_{current_date}/{tables_spark[0]}.csv",header = True)
    ...
    df_base = spark.read.csv(
        f"webhdfs://192.168.0.110:50070/Data_lake/Bronse/db_data/folder_{current_date}/{tables_spark[1]}.csv",header = True)
    df_base = df_base.dropDuplicates()
    ...
    df_base = spark.read.csv(
        f"webhdfs://192.168.0.110:50070/Data_lake/Bronse/db_data/folder_{current_date}/{tables_spark[2]}.csv",header = True)
    df_base = df_base.dropDuplicates()
    ...
    df_base = spark.read.csv(
        f"webhdfs://192.168.0.110:50070/Data_lake/Bronse/db_data/folder_{current_date}/{tables_spark[3]}.csv",header = True)
    df_base = df_base.dropDuplicates()
    ...
    df_base = spark.read.csv(
        f"webhdfs://192.168.0.110:50070/Data_lake/Bronse/db_data/folder_{current_date}/{tables_spark[4]}.csv",header = True)
    df_base = df_base.dropDuplicates()
    ...
    df_base = spark.read.csv(
        f"webhdfs://192.168.0.110:50070/Data_lake/Bronse/db_data/folder_{current_date}/{tables_spark[5]}.csv",header = True)
    df_base = df_base.dropDuplicates()
    ...
    df_base = spark.read.csv(
        f"webhdfs://192.168.0.110:50070/Data_lake/Bronse/db_data/folder_{current_date}/{tables_spark[6]}.csv",header = True)
    df_base = df_base.dropDuplicates()
    ...
    df_base = spark.read.csv(
        f"webhdfs://192.168.0.110:50070/Data_lake/Bronse/db_data/folder_{current_date}/{tables_spark[7]}.csv",header = True)
    df_base = df_base.dropDuplicates()
